...
const PotDrawing = ({ percentage }: { percentage: number }) => {
  ...
  return (
    <div className="relative w-32 h-44 mx-auto mb-4 animate-fade-in">
      {" "}
      <svg
        viewBox="0 0 100 120"
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to bottom right, #1C1A17, #2C2A26)",
            color: "#C5A059",
          }}
        >
          {" "}
          ...
          <div className="relative z-10 text-center">
            {" "}
            <h3
              className="font-sans text-[10px] uppercase tracking-[0.2em] font-bold mb-4"
              style={{ color: "#C5A059" }}
            >
              {" "}
              Pote Sagrado{" "}
            ...
            <h2 className="font-serif italic text-2xl text-white mb-2">
              {" "}
              Destino: {destination || "Nossa Viagem"}{" "}
            </h2>{" "}
            <div
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    width: `${percentage}%`,
                    background: "linear-gradient(to right, #C5A059, #FDE047)",
                  }}
                />{" "}
              </div>{" "}
            </div>{" "}
            <p
              className="font-sans text-[9px] uppercase tracking-widest font-bold mt-6 mb-2"
        ...
        <div className="mt-8 flex justify-between gap-4">
          ...
          >
            ...
            {isExporting ? (
              ...
              <>
                {" "}
                <Download size={14} /> Salvar P/ Story{" "}
              </>
            )}{" "}
          </button>{" "}
        </div>{" "}
        <p className="text-center font-sans text-[9px] text-cookbook-text/40 font-bold tracking-wider mt-4">
          {" "}
          <AlertCircle size={10} className="inline mr-1" /> A imagem com fundo
          transparente será baixada para compartilhar no Instagram!{" "}
        </p>{" "}
      </div>{" "}
    </div>
  );
