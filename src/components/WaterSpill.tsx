      ...
      {isSpilling && (
        ...
        >
          ...
          <motion.div
            ...
            animate={{ opacity: [0, 1, 1, 0], scale: [0.9, 1.05, 1.05, 1.1], y: [20, 0, 0, -20] }}
            transition={{ duration: 3.5, ease: 'easeOut', times: [0, 0.2, 0.8, 1] }}
          >
          ...
          {[...Array(25)].map((_, i) => (
            <motion.div
              ...
              animate={{ 
                ...
                y: (Math.random() - 0.5) * -500 - 100, // Float elegantly upwards
