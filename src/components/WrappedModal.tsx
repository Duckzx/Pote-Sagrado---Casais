...
import { X, Trophy, Sparkles, Coins, Flame, Share2, Download } from "lucide-react";
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: "Nosso Sonho ❤️",
          text: `Já guardamos ${BRL.format(totalSaved)} e estamos ${progress.toFixed(0)}% mais perto de ${destination || "nosso destino"}!`,
            ...
            <div className="px-6 relative z-10">
              ...
              <p className="font-sans text-sm text-white/80 text-balance leading-relaxed max-w-[280px] mx-auto">
                {user1Total === user2Total || !user1 || !user2
                  ...
                  : `Carregou o pote com amor, somando ${BRL.format(bestAmount)}. Que orgulho!`}
              </p>
            </div>
          </motion.div>
        );
