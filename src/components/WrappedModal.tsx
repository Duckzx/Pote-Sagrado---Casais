...
export const WrappedModal: React.FC<WrappedModalProps> = ({
  ...
  /* Statistics Calculation */ const progress =
    goalAmount > 0 ? Math.min(100, (totalSaved / goalAmount) * 100) : 0;
  const savingsDeposits = deposits.filter((d) => d.type !== "expense");
  const numDeposits = savingsDeposits.length;
  /* Who saved the most? */ let user1 = "";
  let user2 = "";
  let user1Total = 0;
  let user2Total = 0;
  ...
  /* Biggest single save */ let biggestSave = 0;
  let biggestSaver = "";
  savingsDeposits.forEach((d) => {
  ...
  /* Handle tap for navigating stories */ const handleTap = (
          ...
          >
            ...
            <div className="px-6">
              ...
              <p className="font-sans text-xs text-white/80 leading-relaxed">
                {" "}
                Vocês investiram no sonho! Cada depósito foi um passo para
                transformar rotina em passagem.{" "}
              </p>{" "}
            </div>{" "}
          </div>
        );
        ...
        return (
          ...
          >
            ...
            <div className="px-6">
              ...
              <p className="font-sans text-xs text-white/80 text-balance leading-relaxed">
                {" "}
                Aquele depósito de respeito que deu um salto absurdo no Pote
                Sagrado.{" "}
              </p>{" "}
            </div>{" "}
          </div>
