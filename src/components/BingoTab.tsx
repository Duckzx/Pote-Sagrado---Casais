  ...
  return (
    <div className="pb-24 pt-6 px-6 max-w-md mx-auto">
      ...
      <div className="text-center mb-8">
        {" "}
        <h2 className="font-serif text-2xl text-cookbook-text mb-2">
          {" "}
          Bingo de Atitudes{" "}
        </h2>{" "}
        ...
        {allActions.map((action) => {
          ...
          return (
            <button
              ...
              className="relative aspect-square bg-cookbook-bg border border-cookbook-border rounded p-2 flex flex-col items-center justify-center text-center shadow-sm transition-transform active:scale-95 hover:bg-cookbook-primary hover:text-white hover:border-cookbook-primary group"
            >
              {" "}
      ...
      {selectedAction && (
        <div
          className="fixed inset-0 z-50 flex items-start pt-20 justify-center p-4 overflow-y-auto animate-modal-backdrop"
          style={{
