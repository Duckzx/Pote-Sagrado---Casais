...
function AppContent() {
  ...
  React.useEffect(() => {
    ...
    if (previous && previous.length > 0) {
      // BOLT: Optimize deposit lookup from O(N*M) to O(N+M) using a Map
