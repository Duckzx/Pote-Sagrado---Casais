          ...
          <div className="space-y-4">
            ...
            {loginError === 'blocked' && (
               <div className="bg-white/60 p-4 rounded-xl text-left shadow-sm mt-4 font-sans text-xs text-cookbook-text border border-red-200/50">
                 <p className="font-bold mb-2">Bloqueio do Navegador Detectado!</p>
                 <p className="mb-4">O Instagram/WhatsApp não permite login pelo Google nesta tela.</p>
                 ...
                 <button
                    onClick={() => {
                      navigator.clipboard.writeText('https://pote-sagrado-casais.vercel.app/');
                      addToast('Link copiado!', 'Agora abra o Safari ou Chrome e cole na barra de busca.', 'success');
                    }}
                   className="w-full bg-cookbook-bg text-cookbook-text border border-cookbook-border font-bold py-3 rounded-lg flex items-center justify-center gap-2"
                 >
             ...
             {loginError === 'unauthorized' && (
               <div className="bg-white/60 p-4 rounded-xl text-left shadow-sm mt-4 font-sans text-xs text-cookbook-text border border-orange-200/50">
                 <p className="font-bold mb-2">Configuração do Firebase Pendente</p>
                 <p className="mb-2">Para entrar pelo <strong className="font-bold">pote-sagrado-casais.vercel.app</strong> você deve adicionar este domínio como Autorizado.</p>
                 <p className="mb-1 text-[10px] opacity-80">No painel do Firebase: Authentication &gt; Settings &gt; Authorized Domains</p>
               </div>
            )}
          </div>
        </div>
